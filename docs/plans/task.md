...
| Task 3: Preload API Bridge & Types Definition | Pending | Define IPC types and expose `window.api.vault` |
...
| Task 10: Verification & Build Validation | Pending | Perform typecheck and dev build verification |
